...
const svgBase = (className?: string) =>
  `${className || defaults} inline-block flex-shrink-0`;

export function IconEdit({ className }: IconProps) {
  return (
    <svg className={svgBase(className)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconSquare({ className }: IconProps) {
  return (
    <svg className={svgBase(className)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconFlask({ className }: IconProps) {
  return (
    <svg className={svgBase(className)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M10 9V3" />
      <path d="M14 9V3" />
      <path d="m10 9-3.54 7.08A2 2 0 0 0 8.24 19h7.52a2 2 0 0 0 1.78-2.92L14 9" />
    </svg>
  );
}
